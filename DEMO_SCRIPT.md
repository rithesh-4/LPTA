...
```
> "87 unit tests pass. The tool is deterministic — same input produces byte-identical output. The test suite includes hand-verified ground truth, fuzz testing, and cross-validation against LLVM's own opt -stats."
